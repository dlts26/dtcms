...
<script src="${ctx}/plugins/easyui/common/index.js" type="text/javascript"></script>
<link href="${ctx}/plugins/easyui/common/index.css" rel="stylesheet" />
<script src="${ctx}/plugins/easyui/common/index-startup.js"></script>
</head>
<body>
    <div id="dlg"></div>  
	<!-- 容器遮罩 -->
