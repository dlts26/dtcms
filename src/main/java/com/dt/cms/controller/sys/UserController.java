...
import com.dt.cms.service.sys.UserOrgService;
import com.dt.cms.service.sys.UserRoleService;
...
public class UserController extends BaseController {
	...
	@ResponseBody
	public String update(@ModelAttribute @RequestBody User user,Model model) {
	...
	@ResponseBody
	public String updateUserOrg(@PathVariable("id") Integer id,@RequestBody List<Integer> newOrgList) {
		userOrgService.updateUserOrg(id,newOrgList);
		return "success";
	}
	...
	@ResponseBody
	public String updatePwd(String oldPassword, @ModelAttribute @RequestBody User user, HttpSession session) {
